...
public class _05_RobotFileUpload extends BaseDriver {
    ...
    public void test() throws AWTException {
        ...
        //StringSelection dosyaYolu = new StringSelection("C:\\Users\\mert_\\OneDrive\\Desktop\\Mert ÖZMEN CV.pdf");
        //Toolkit.getDefaultToolkit().getSystemClipboard().setContents(dosyaYolu, null); // ctrl+c bu kopyaladı panoya
        // Bu kısmı güvenlik için yoruma aldım,çalışıyor kod normalde.


        robot.keyPress(KeyEvent.VK_CONTROL);
        robot.keyPress(KeyEvent.VK_V); // ctrl+v yapıştırmayı yaptı
